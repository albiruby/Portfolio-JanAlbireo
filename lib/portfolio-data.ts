export const data = {
  ...
  education: [
    {
      ...
      degree: "D4 / Applied Bachelor Degree in Teknik Multimedia Digital",
      description: "Relevant Coursework: Interactive Multimedia, UI/UX Design, 3D Modeling and Animation, Game Development, Web Programming, Mobile Programming, Database, Embedded System, IoT, Digital Multimedia Production."
    },
    {
  ...
  certifications: [
    {
      title: "Digital Talent Scholarship 2025",
      organizer: "BPSDMP Jakarta",
      period: "Jul 2025",
  ...
  academicExperience: [
    {
      ...
      organization: "Politeknik Negeri Jakarta",
      period: "2023 – Present",
